      ...
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md space-y-6 border border-border p-8 rounded-lg shadow-sm bg-card">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground">{localization.signInDescription}</p>
          </div>
          ...
          <div className="text-center text-sm">
            <Link href={`/${language}/sign-up`} className="underline underline-offset-4 hover:text-primary">
              {localization.signUp}
            </Link>
          </div>
        </div>
