      ...
      <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-1">
              <div className="flex flex-col justify-center items-center flex-1">
                  <div>
                      <h1 className={"text-8xl gradiant-text uppercase italic pe-8 -translate-x-4 " + pacifico.className}>Rbeer</h1>
                      <p className="mt-5">{localization.slogan}</p>
                      <div className="flex space-x-2 mt-5">
                          <Button className="px-4">{localization.signIn}</Button>
                          <Button className="px-4">{localization.signUp}</Button>
                      </div>
                  </div>
              </div>
